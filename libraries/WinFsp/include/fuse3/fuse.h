...
struct fuse3_operations
{
    ...
    /* S */ int (*mknod)(const char *path, fuse_fuse_mode_t mode, fuse_dev_t dev);
    /* S */ int (*mkdir)(const char *path, fuse_fuse_mode_t mode);
    ...
    /* S */ int (*chmod)(const char *path, fuse_fuse_mode_t mode,
        struct fuse3_file_info *fi);
    /* S */ int (*chown)(const char *path, fuse_fuse_uid_t uid, fuse_gid_t gid,
        struct fuse3_file_info *fi);
    ...
    /* S */ int (*create)(const char *path, fuse_fuse_mode_t mode, struct fuse3_file_info *fi);
